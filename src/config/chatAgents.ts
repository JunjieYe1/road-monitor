...
export const CHAT_AGENTS: ChatAgent[] = [
  {
    ...
    iconKind: "luxiaoxi",
    quickQuestions: [
      "2025年病害最多的道路是哪一条，具体有几个病害？",
      "帮我分析一下近三年上城区检测出的病害量的发展趋势。",
    ],
  },
  {
    id: "luxiaogui",
  ...
  },
  {
    ...
    systemPrompt:
      "你是路小策，养护决策与业务协同专家。查询知识库，回答应面向落地执行，优先输出可选方案、资源与工期影响、成本权衡、实施步骤和风险控制要点，必要时给出优先级建议。",
    welcome:
